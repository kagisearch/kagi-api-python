...
class TestSearch200ResponseDataInner(unittest.TestCase):
    """Search200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Search200ResponseDataInner:
        """Test Search200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Search200ResponseDataInner`
        """
        model = Search200ResponseDataInner()
        if include_optional:
            return Search200ResponseDataInner(
                t = 56,
                rank = 56,
                url = '',
                title = '',
                snippet = '',
                published = '',
                thumbnail = openapi_client.models.v1_result_search_image.v1ResultSearch_image(
                    url = '', 
                    height = 56, 
                    width = 56, ),
    ...
    def testSearch200ResponseDataInner(self):
        """Test Search200ResponseDataInner"""
