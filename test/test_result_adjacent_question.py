...
class TestResultAdjacentQuestion(unittest.TestCase):
    """ResultAdjacentQuestion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultAdjacentQuestion:
        """Test ResultAdjacentQuestion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultAdjacentQuestion`
        """
        model = ResultAdjacentQuestion()
        if include_optional:
            return ResultAdjacentQuestion(
                url = '',
                title = '',
                snippet = '',
                time = '',
    ...
    def testResultAdjacentQuestion(self):
        """Test ResultAdjacentQuestion"""
