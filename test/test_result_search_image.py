...
class TestResultSearchImage(unittest.TestCase):
    """ResultSearchImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultSearchImage:
        """Test ResultSearchImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultSearchImage`
        """
        model = ResultSearchImage()
        if include_optional:
            return ResultSearchImage(
                url = '',
                height = 56,
                width = 56
            )
    ...
    def testResultSearchImage(self):
        """Test ResultSearchImage"""
