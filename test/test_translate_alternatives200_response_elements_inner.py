...
class TestTranslateAlternatives200ResponseElementsInner(unittest.TestCase):
    """TranslateAlternatives200ResponseElementsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateAlternatives200ResponseElementsInner:
        """Test TranslateAlternatives200ResponseElementsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateAlternatives200ResponseElementsInner`
        """
        model = TranslateAlternatives200ResponseElementsInner()
        if include_optional:
            return TranslateAlternatives200ResponseElementsInner(
                translation = '',
                explanation = ''
            )
        else:
    ...
    def testTranslateAlternatives200ResponseElementsInner(self):
        """Test TranslateAlternatives200ResponseElementsInner"""
