...
class TestV1ResultInfoboxPropsInfoboxInner(unittest.TestCase):
    """V1ResultInfoboxPropsInfoboxInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultInfoboxPropsInfoboxInner:
        """Test V1ResultInfoboxPropsInfoboxInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultInfoboxPropsInfoboxInner`
        """
        model = V1ResultInfoboxPropsInfoboxInner()
        if include_optional:
            return V1ResultInfoboxPropsInfoboxInner(
                header = '',
                value = '',
                merged = True
            )
    ...
    def testV1ResultInfoboxPropsInfoboxInner(self):
        """Test V1ResultInfoboxPropsInfoboxInner"""
