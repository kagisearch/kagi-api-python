...
class TestTranslateListLanguagesPostRequest(unittest.TestCase):
    """TranslateListLanguagesPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateListLanguagesPostRequest:
        """Test TranslateListLanguagesPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateListLanguagesPostRequest`
        """
        model = TranslateListLanguagesPostRequest()
        if include_optional:
            return TranslateListLanguagesPostRequest(
                type = 'source',
                locale = ''
            )
        else:
    ...
    def testTranslateListLanguagesPostRequest(self):
        """Test TranslateListLanguagesPostRequest"""
