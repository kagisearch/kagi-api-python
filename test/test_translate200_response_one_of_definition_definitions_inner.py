...
class TestTranslate200ResponseOneOfDefinitionDefinitionsInner(unittest.TestCase):
    """Translate200ResponseOneOfDefinitionDefinitionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Translate200ResponseOneOfDefinitionDefinitionsInner:
        """Test Translate200ResponseOneOfDefinitionDefinitionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Translate200ResponseOneOfDefinitionDefinitionsInner`
        """
        model = Translate200ResponseOneOfDefinitionDefinitionsInner()
        if include_optional:
            return Translate200ResponseOneOfDefinitionDefinitionsInner(
                part_of_speech = 'noun',
                meanings = [
    ...
    def testTranslate200ResponseOneOfDefinitionDefinitionsInner(self):
        """Test Translate200ResponseOneOfDefinitionDefinitionsInner"""
