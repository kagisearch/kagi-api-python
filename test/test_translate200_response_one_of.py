...
class TestTranslate200ResponseOneOf(unittest.TestCase):
    """Translate200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Translate200ResponseOneOf:
        """Test Translate200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Translate200ResponseOneOf`
        """
        model = Translate200ResponseOneOf()
        if include_optional:
            return Translate200ResponseOneOf(
                translation = 'Hola mundo',
                detected_language = openapi_client.models.translate_200_response_one_of_detected_language.translate_200_response_oneOf_detectedLanguage(
                    iso = 'en', 
                    label = 'English', ),
                definition = openapi_client.models.translate_200_response_one_of_definition.translate_200_response_oneOf_definition(
                    word = 'casa', 
                    phonetic = '/ˈkasa/', 
                    definitions = [
                        openapi_client.models.translate_200_response_one_of_definition_definitions_inner.translate_200_response_oneOf_definition_definitions_inner(
                            part_of_speech = 'noun', 
                            meanings = [
                                openapi_client.models.translate_200_response_one_of_definition_definitions_inner_meanings_inner.translate_200_response_oneOf_definition_definitions_inner_meanings_inner(
    ...
    def testTranslate200ResponseOneOf(self):
        """Test Translate200ResponseOneOf"""
