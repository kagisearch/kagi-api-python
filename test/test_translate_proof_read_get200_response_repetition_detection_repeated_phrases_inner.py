...
class TestTranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner(unittest.TestCase):
    """TranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner:
        """Test TranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner`
        """
        model = TranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner()
        if include_optional:
            return TranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner(
                phrase = '',
                significance = ''
            )
        else:
    ...
    def testTranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner(self):
        """Test TranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner"""
