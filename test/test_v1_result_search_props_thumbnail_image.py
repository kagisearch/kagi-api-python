...
class TestV1ResultSearchPropsThumbnailImage(unittest.TestCase):
    """V1ResultSearchPropsThumbnailImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultSearchPropsThumbnailImage:
        """Test V1ResultSearchPropsThumbnailImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultSearchPropsThumbnailImage`
        """
        model = V1ResultSearchPropsThumbnailImage()
        if include_optional:
            return V1ResultSearchPropsThumbnailImage(
                url = '',
                height = 56,
                width = 56
            )
    ...
    def testV1ResultSearchPropsThumbnailImage(self):
        """Test V1ResultSearchPropsThumbnailImage"""
