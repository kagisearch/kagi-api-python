...
class TestV1ResultAdjacentQuestion(unittest.TestCase):
    """V1ResultAdjacentQuestion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultAdjacentQuestion:
        """Test V1ResultAdjacentQuestion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultAdjacentQuestion`
        """
        model = V1ResultAdjacentQuestion()
        if include_optional:
            return V1ResultAdjacentQuestion(
                url = '',
                title = '',
                snippet = '',
                time = '',
    ...
    def testV1ResultAdjacentQuestion(self):
        """Test V1ResultAdjacentQuestion"""
