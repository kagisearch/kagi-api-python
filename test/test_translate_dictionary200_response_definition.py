...
class TestTranslateDictionary200ResponseDefinition(unittest.TestCase):
    """TranslateDictionary200ResponseDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateDictionary200ResponseDefinition:
        """Test TranslateDictionary200ResponseDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateDictionary200ResponseDefinition`
        """
        model = TranslateDictionary200ResponseDefinition()
        if include_optional:
            return TranslateDictionary200ResponseDefinition(
                word = 'hello',
    ...
    def testTranslateDictionary200ResponseDefinition(self):
        """Test TranslateDictionary200ResponseDefinition"""
