...
class TestV1ResultVideo(unittest.TestCase):
    """V1ResultVideo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultVideo:
        """Test V1ResultVideo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultVideo`
        """
        model = V1ResultVideo()
        if include_optional:
            return V1ResultVideo(
                url = '',
                title = '',
                snippet = '',
                time = '',
