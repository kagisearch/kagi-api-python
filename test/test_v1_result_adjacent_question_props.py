...
class TestV1ResultAdjacentQuestionProps(unittest.TestCase):
    """V1ResultAdjacentQuestionProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultAdjacentQuestionProps:
        """Test V1ResultAdjacentQuestionProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultAdjacentQuestionProps`
        """
        model = V1ResultAdjacentQuestionProps()
        if include_optional:
            return V1ResultAdjacentQuestionProps(
                question = '',
                language = '',
    ...
    def testV1ResultAdjacentQuestionProps(self):
        """Test V1ResultAdjacentQuestionProps"""
