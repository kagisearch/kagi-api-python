...
class TestTranslateDictionary200ResponseDefinitionSecondaryMeaningsInner(unittest.TestCase):
    """TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner:
        """Test TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner`
        """
        model = TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner()
        if include_optional:
            return TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner(
                definition = 'An expression of surprise',
                part_of_speech = ["noun"],
                usage_level = ["informal"],
                dialect = ["US"],
                synonyms = ["wow","oh my","goodness"]
            )
        else:
            return TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner(
        )
    ...
    def testTranslateDictionary200ResponseDefinitionSecondaryMeaningsInner(self):
        """Test TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner"""
