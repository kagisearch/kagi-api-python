...
class TestTranslateTextAlignments200Response(unittest.TestCase):
    """TranslateTextAlignments200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateTextAlignments200Response:
        """Test TranslateTextAlignments200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateTextAlignments200Response`
        """
        model = TranslateTextAlignments200Response()
        if include_optional:
            return TranslateTextAlignments200Response(
                alignments = [
                    openapi_client.models.translate_text_alignments_200_response_alignments_inner.translateTextAlignments_200_response_alignments_inner(
                        source = '', 
                        target = '', )
                    ]
            )
    ...
    def testTranslateTextAlignments200Response(self):
        """Test TranslateTextAlignments200Response"""
