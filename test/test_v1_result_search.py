...
class TestV1ResultSearch(unittest.TestCase):
    """V1ResultSearch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultSearch:
        """Test V1ResultSearch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultSearch`
        """
        model = V1ResultSearch()
        if include_optional:
            return V1ResultSearch(
                url = '',
                title = '',
                snippet = '',
                time = '',
