...
class TestSearchRelated(unittest.TestCase):
    """SearchRelated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchRelated:
        """Test SearchRelated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchRelated`
        """
        model = SearchRelated()
        if include_optional:
