...
class TestTranslate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner(unittest.TestCase):
    """Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner:
        """Test Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner`
        """
        model = Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner()
        if include_optional:
            return Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner(
    ...
    def testTranslate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner(self):
        """Test Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner"""
