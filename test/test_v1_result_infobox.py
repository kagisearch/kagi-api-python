...
class TestV1ResultInfobox(unittest.TestCase):
    """V1ResultInfobox unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultInfobox:
        """Test V1ResultInfobox
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultInfobox`
        """
        model = V1ResultInfobox()
        if include_optional:
            return V1ResultInfobox(
                url = '',
                title = '',
                snippet = '',
                time = '',
