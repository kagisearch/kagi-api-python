...
class TestV1MetaQuery(unittest.TestCase):
    """V1MetaQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1MetaQuery:
        """Test V1MetaQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1MetaQuery`
        """
        model = V1MetaQuery()
        if include_optional:
            return V1MetaQuery(
