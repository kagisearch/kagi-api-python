...
class TestTranslateDictionary200ResponseDefinitionPrimaryMeaning(unittest.TestCase):
    """TranslateDictionary200ResponseDefinitionPrimaryMeaning unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateDictionary200ResponseDefinitionPrimaryMeaning:
        """Test TranslateDictionary200ResponseDefinitionPrimaryMeaning
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateDictionary200ResponseDefinitionPrimaryMeaning`
        """
        model = TranslateDictionary200ResponseDefinitionPrimaryMeaning()
        if include_optional:
            return TranslateDictionary200ResponseDefinitionPrimaryMeaning(
    ...
    def testTranslateDictionary200ResponseDefinitionPrimaryMeaning(self):
        """Test TranslateDictionary200ResponseDefinitionPrimaryMeaning"""
