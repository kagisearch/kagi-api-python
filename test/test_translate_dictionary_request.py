...
class TestTranslateDictionaryRequest(unittest.TestCase):
    """TranslateDictionaryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateDictionaryRequest:
        """Test TranslateDictionaryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateDictionaryRequest`
        """
        model = TranslateDictionaryRequest()
        if include_optional:
            return TranslateDictionaryRequest(
                word = '',
                word_language = 'en',
    ...
    def testTranslateDictionaryRequest(self):
        """Test TranslateDictionaryRequest"""
