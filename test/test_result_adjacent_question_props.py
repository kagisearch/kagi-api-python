...
class TestResultAdjacentQuestionProps(unittest.TestCase):
    """ResultAdjacentQuestionProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultAdjacentQuestionProps:
        """Test ResultAdjacentQuestionProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultAdjacentQuestionProps`
        """
        model = ResultAdjacentQuestionProps()
        if include_optional:
            return ResultAdjacentQuestionProps(
                question = '',
                language = '',
    ...
    def testResultAdjacentQuestionProps(self):
        """Test ResultAdjacentQuestionProps"""
