...
class TestFastGPTRequest(unittest.TestCase):
    """FastGPTRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FastGPTRequest:
        """Test FastGPTRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FastGPTRequest`
        """
        model = FastGPTRequest()
        if include_optional:
            return FastGPTRequest(
                query = '',
                cache = True
            )
        else:
