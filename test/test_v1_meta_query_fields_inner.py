...
class TestV1MetaQueryFieldsInner(unittest.TestCase):
    """V1MetaQueryFieldsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1MetaQueryFieldsInner:
        """Test V1MetaQueryFieldsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1MetaQueryFieldsInner`
        """
        model = V1MetaQueryFieldsInner()
        if include_optional:
            return V1MetaQueryFieldsInner(
                kind = '',
                value = '',
                name = '',
                negate = True
    ...
    def testV1MetaQueryFieldsInner(self):
        """Test V1MetaQueryFieldsInner"""
