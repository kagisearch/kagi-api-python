...
class TestTranslateTextAlignments200ResponseAlignmentsInner(unittest.TestCase):
    """TranslateTextAlignments200ResponseAlignmentsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateTextAlignments200ResponseAlignmentsInner:
        """Test TranslateTextAlignments200ResponseAlignmentsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateTextAlignments200ResponseAlignmentsInner`
        """
        model = TranslateTextAlignments200ResponseAlignmentsInner()
        if include_optional:
            return TranslateTextAlignments200ResponseAlignmentsInner(
                source = '',
                target = ''
            )
        else:
    ...
    def testTranslateTextAlignments200ResponseAlignmentsInner(self):
        """Test TranslateTextAlignments200ResponseAlignmentsInner"""
