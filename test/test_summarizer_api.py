...
class TestSummarizerApi(unittest.TestCase):
    """SummarizerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SummarizerApi()

    def tearDown(self) -> None:
        pass

    def test_summarize_text(self) -> None:
        """Test case for summarize_text

        Upload text to summarize.
        """
        pass

    def test_summarize_url(self) -> None:
        """Test case for summarize_url
