...
class TestTranslateProofReadGet200ResponseVoiceConsistency(unittest.TestCase):
    """TranslateProofReadGet200ResponseVoiceConsistency unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateProofReadGet200ResponseVoiceConsistency:
        """Test TranslateProofReadGet200ResponseVoiceConsistency
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateProofReadGet200ResponseVoiceConsistency`
        """
        model = TranslateProofReadGet200ResponseVoiceConsistency()
        if include_optional:
            return TranslateProofReadGet200ResponseVoiceConsistency(
    ...
    def testTranslateProofReadGet200ResponseVoiceConsistency(self):
        """Test TranslateProofReadGet200ResponseVoiceConsistency"""
