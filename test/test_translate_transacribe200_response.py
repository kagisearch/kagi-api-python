...
class TestTranslateTransacribe200Response(unittest.TestCase):
    """TranslateTransacribe200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateTransacribe200Response:
        """Test TranslateTransacribe200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateTransacribe200Response`
        """
        model = TranslateTransacribe200Response()
        if include_optional:
    ...
    def testTranslateTransacribe200Response(self):
        """Test TranslateTransacribe200Response"""
