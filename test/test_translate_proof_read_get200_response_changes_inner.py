...
class TestTranslateProofReadGet200ResponseChangesInner(unittest.TestCase):
    """TranslateProofReadGet200ResponseChangesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateProofReadGet200ResponseChangesInner:
        """Test TranslateProofReadGet200ResponseChangesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateProofReadGet200ResponseChangesInner`
        """
        model = TranslateProofReadGet200ResponseChangesInner()
        if include_optional:
            return TranslateProofReadGet200ResponseChangesInner(
                original = '',
                correction = '',
                explanation = '',
                types = [
    ...
    def testTranslateProofReadGet200ResponseChangesInner(self):
        """Test TranslateProofReadGet200ResponseChangesInner"""
