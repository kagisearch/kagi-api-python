...
class TestTranslateProofReadGet200ResponseRepetitionDetection(unittest.TestCase):
    """TranslateProofReadGet200ResponseRepetitionDetection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateProofReadGet200ResponseRepetitionDetection:
        """Test TranslateProofReadGet200ResponseRepetitionDetection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateProofReadGet200ResponseRepetitionDetection`
        """
        model = TranslateProofReadGet200ResponseRepetitionDetection()
        if include_optional:
            return TranslateProofReadGet200ResponseRepetitionDetection(
                repeated_words = [
    ...
    def testTranslateProofReadGet200ResponseRepetitionDetection(self):
        """Test TranslateProofReadGet200ResponseRepetitionDetection"""
