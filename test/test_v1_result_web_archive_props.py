...
class TestV1ResultWebArchiveProps(unittest.TestCase):
    """V1ResultWebArchiveProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultWebArchiveProps:
        """Test V1ResultWebArchiveProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultWebArchiveProps`
        """
        model = V1ResultWebArchiveProps()
        if include_optional:
            return V1ResultWebArchiveProps(
                web_archive_domain = '',
                language = '',
    ...
    def testV1ResultWebArchiveProps(self):
        """Test V1ResultWebArchiveProps"""
