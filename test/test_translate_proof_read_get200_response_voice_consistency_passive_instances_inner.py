...
class TestTranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner(unittest.TestCase):
    """TranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner:
        """Test TranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner`
        """
        model = TranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner()
        if include_optional:
            return TranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner(
                passive = '',
                active_alternative = ''
            )
        else:
    ...
    def testTranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner(self):
        """Test TranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner"""
