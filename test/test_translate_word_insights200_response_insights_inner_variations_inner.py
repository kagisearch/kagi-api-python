...
class TestTranslateWordInsights200ResponseInsightsInnerVariationsInner(unittest.TestCase):
    """TranslateWordInsights200ResponseInsightsInnerVariationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateWordInsights200ResponseInsightsInnerVariationsInner:
        """Test TranslateWordInsights200ResponseInsightsInnerVariationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateWordInsights200ResponseInsightsInnerVariationsInner`
        """
        model = TranslateWordInsights200ResponseInsightsInnerVariationsInner()
        if include_optional:
            return TranslateWordInsights200ResponseInsightsInnerVariationsInner(
                text = 'Saludos',
    ...
    def testTranslateWordInsights200ResponseInsightsInnerVariationsInner(self):
        """Test TranslateWordInsights200ResponseInsightsInnerVariationsInner"""
