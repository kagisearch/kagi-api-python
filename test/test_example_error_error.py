...
class TestExampleErrorError(unittest.TestCase):
    """ExampleErrorError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExampleErrorError:
        """Test ExampleErrorError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExampleErrorError`
        """
        model = ExampleErrorError()
        if include_optional:
            return ExampleErrorError(
                code = 56,
                msg = '',
                ref = ''
            )
    ...
    def testExampleErrorError(self):
        """Test ExampleErrorError"""
