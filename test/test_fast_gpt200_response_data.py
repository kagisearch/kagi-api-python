...
class TestFastGPT200ResponseData(unittest.TestCase):
    """FastGPT200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FastGPT200ResponseData:
        """Test FastGPT200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FastGPT200ResponseData`
        """
        model = FastGPT200ResponseData()
        if include_optional:
            return FastGPT200ResponseData(
                output = '',
                tokens = 56,
                references = [
    ...
    def testFastGPT200ResponseData(self):
        """Test FastGPT200ResponseData"""
