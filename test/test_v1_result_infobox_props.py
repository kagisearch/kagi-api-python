...
class TestV1ResultInfoboxProps(unittest.TestCase):
    """V1ResultInfoboxProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultInfoboxProps:
        """Test V1ResultInfoboxProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultInfoboxProps`
        """
        model = V1ResultInfoboxProps()
        if include_optional:
            return V1ResultInfoboxProps(
                infobox = [
    ...
    def testV1ResultInfoboxProps(self):
        """Test V1ResultInfoboxProps"""
