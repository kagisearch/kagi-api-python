...
class TestResultVideo(unittest.TestCase):
    """ResultVideo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultVideo:
        """Test ResultVideo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultVideo`
        """
        model = ResultVideo()
        if include_optional:
            return ResultVideo(
