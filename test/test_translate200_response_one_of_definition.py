...
class TestTranslate200ResponseOneOfDefinition(unittest.TestCase):
    """Translate200ResponseOneOfDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Translate200ResponseOneOfDefinition:
        """Test Translate200ResponseOneOfDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Translate200ResponseOneOfDefinition`
        """
        model = Translate200ResponseOneOfDefinition()
        if include_optional:
            return Translate200ResponseOneOfDefinition(
                word = 'casa',
                phonetic = '/ˈkasa/',
                definitions = [
    ...
    def testTranslate200ResponseOneOfDefinition(self):
        """Test Translate200ResponseOneOfDefinition"""
