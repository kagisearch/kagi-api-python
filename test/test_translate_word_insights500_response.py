...
class TestTranslateWordInsights500Response(unittest.TestCase):
    """TranslateWordInsights500Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateWordInsights500Response:
        """Test TranslateWordInsights500Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateWordInsights500Response`
        """
        model = TranslateWordInsights500Response()
        if include_optional:
            return TranslateWordInsights500Response(
                error = 'Failed to get word insights'
            )
        else:
            return TranslateWordInsights500Response(
        )
    ...
    def testTranslateWordInsights500Response(self):
        """Test TranslateWordInsights500Response"""
