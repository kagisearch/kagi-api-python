...
class TestTranslateFile403Response(unittest.TestCase):
    """TranslateFile403Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateFile403Response:
        """Test TranslateFile403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateFile403Response`
        """
        model = TranslateFile403Response()
        if include_optional:
            return TranslateFile403Response(
                error = 'Multi-language translation is restricted'
            )
        else:
            return TranslateFile403Response(
        )
    ...
    def testTranslateFile403Response(self):
        """Test TranslateFile403Response"""
