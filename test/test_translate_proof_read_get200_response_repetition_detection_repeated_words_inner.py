...
class TestTranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner(unittest.TestCase):
    """TranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner:
        """Test TranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner`
        """
        model = TranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner()
        if include_optional:
            return TranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner(
                word = '',
                significance = ''
            )
        else:
    ...
    def testTranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner(self):
        """Test TranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner"""
