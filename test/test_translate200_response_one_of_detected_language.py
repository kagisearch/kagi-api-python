...
class TestTranslate200ResponseOneOfDetectedLanguage(unittest.TestCase):
    """Translate200ResponseOneOfDetectedLanguage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Translate200ResponseOneOfDetectedLanguage:
        """Test Translate200ResponseOneOfDetectedLanguage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Translate200ResponseOneOfDetectedLanguage`
        """
        model = Translate200ResponseOneOfDetectedLanguage()
        if include_optional:
            return Translate200ResponseOneOfDetectedLanguage(
                iso = 'en',
                label = 'English'
            )
        else:
    ...
    def testTranslate200ResponseOneOfDetectedLanguage(self):
        """Test Translate200ResponseOneOfDetectedLanguage"""
