...
class TestResultSearch(unittest.TestCase):
    """ResultSearch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultSearch:
        """Test ResultSearch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultSearch`
        """
        model = ResultSearch()
        if include_optional:
            return ResultSearch(
