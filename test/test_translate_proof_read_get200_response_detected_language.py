...
class TestTranslateProofReadGet200ResponseDetectedLanguage(unittest.TestCase):
    """TranslateProofReadGet200ResponseDetectedLanguage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateProofReadGet200ResponseDetectedLanguage:
        """Test TranslateProofReadGet200ResponseDetectedLanguage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateProofReadGet200ResponseDetectedLanguage`
        """
        model = TranslateProofReadGet200ResponseDetectedLanguage()
        if include_optional:
            return TranslateProofReadGet200ResponseDetectedLanguage(
                iso = '',
                label = ''
            )
        else:
    ...
    def testTranslateProofReadGet200ResponseDetectedLanguage(self):
        """Test TranslateProofReadGet200ResponseDetectedLanguage"""
