...
class TestTranslateProofReadGet200ResponseToneAnalysis(unittest.TestCase):
    """TranslateProofReadGet200ResponseToneAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateProofReadGet200ResponseToneAnalysis:
        """Test TranslateProofReadGet200ResponseToneAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateProofReadGet200ResponseToneAnalysis`
        """
        model = TranslateProofReadGet200ResponseToneAnalysis()
        if include_optional:
            return TranslateProofReadGet200ResponseToneAnalysis(
                overall_tone = '',
                description = '',
                suggestions = ''
            )
    ...
    def testTranslateProofReadGet200ResponseToneAnalysis(self):
        """Test TranslateProofReadGet200ResponseToneAnalysis"""
