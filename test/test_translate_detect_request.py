...
class TestTranslateDetectRequest(unittest.TestCase):
    """TranslateDetectRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateDetectRequest:
        """Test TranslateDetectRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateDetectRequest`
        """
        model = TranslateDetectRequest()
        if include_optional:
            return TranslateDetectRequest(
                text = ''
            )
        else:
            return TranslateDetectRequest(
    ...
    def testTranslateDetectRequest(self):
        """Test TranslateDetectRequest"""
