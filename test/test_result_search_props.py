...
class TestResultSearchProps(unittest.TestCase):
    """ResultSearchProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultSearchProps:
        """Test ResultSearchProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultSearchProps`
        """
        model = ResultSearchProps()
        if include_optional:
            return ResultSearchProps(
    ...
    def testResultSearchProps(self):
        """Test ResultSearchProps"""
