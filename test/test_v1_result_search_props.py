...
class TestV1ResultSearchProps(unittest.TestCase):
    """V1ResultSearchProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultSearchProps:
        """Test V1ResultSearchProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultSearchProps`
        """
        model = V1ResultSearchProps()
        if include_optional:
            return V1ResultSearchProps(
    ...
    def testV1ResultSearchProps(self):
        """Test V1ResultSearchProps"""
