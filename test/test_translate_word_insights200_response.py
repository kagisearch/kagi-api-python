...
class TestTranslateWordInsights200Response(unittest.TestCase):
    """TranslateWordInsights200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateWordInsights200Response:
        """Test TranslateWordInsights200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateWordInsights200Response`
        """
        model = TranslateWordInsights200Response()
        if include_optional:
            return TranslateWordInsights200Response(
                marked_translation = '<<INSIGHT_1>> <<INSIGHT_2>>',
                insights = [
                    openapi_client.models.translate_word_insights_200_response_insights_inner.translateWordInsights_200_response_insights_inner(
                        id = 'INSIGHT_1', 
                        original_text = 'Hola', 
                        variations = [
                            openapi_client.models.translate_word_insights_200_response_insights_inner_variations_inner.translateWordInsights_200_response_insights_inner_variations_inner(
                                text = 'Saludos', 
    ...
    def testTranslateWordInsights200Response(self):
        """Test TranslateWordInsights200Response"""
