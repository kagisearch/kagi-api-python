...
class TestExampleError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExampleError:
        """Test ExampleError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExampleError`
        """
        model = ExampleError()
        if include_optional:
            return ExampleError(
                meta = { },
                error = openapi_client.models.example_error_error.exampleError_error(
                    code = 56, 
                    msg = '', 
                    ref = '', )
            )
