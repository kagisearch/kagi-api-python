...
class TestV1ResultVideoProps(unittest.TestCase):
    """V1ResultVideoProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultVideoProps:
        """Test V1ResultVideoProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultVideoProps`
        """
        model = V1ResultVideoProps()
        if include_optional:
            return V1ResultVideoProps(
    ...
    def testV1ResultVideoProps(self):
        """Test V1ResultVideoProps"""
