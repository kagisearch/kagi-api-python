...
class TestV1ResultWebArchive(unittest.TestCase):
    """V1ResultWebArchive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultWebArchive:
        """Test V1ResultWebArchive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultWebArchive`
        """
        model = V1ResultWebArchive()
        if include_optional:
            return V1ResultWebArchive(
                url = '',
                title = '',
                snippet = '',
                time = '',
    ...
    def testV1ResultWebArchive(self):
        """Test V1ResultWebArchive"""
