...
class TestTranslateRequestText(unittest.TestCase):
    """TranslateRequestText unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateRequestText:
        """Test TranslateRequestText
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateRequestText`
        """
        model = TranslateRequestText()
        if include_optional:
    ...
    def testTranslateRequestText(self):
        """Test TranslateRequestText"""
