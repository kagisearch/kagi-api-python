...
class TestResultWebArchiveProps(unittest.TestCase):
    """ResultWebArchiveProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultWebArchiveProps:
        """Test ResultWebArchiveProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultWebArchiveProps`
        """
        model = ResultWebArchiveProps()
        if include_optional:
            return ResultWebArchiveProps(
                web_archive_domain = '',
                language = '',
    ...
    def testResultWebArchiveProps(self):
        """Test ResultWebArchiveProps"""
