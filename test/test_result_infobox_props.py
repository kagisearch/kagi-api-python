...
class TestResultInfoboxProps(unittest.TestCase):
    """ResultInfoboxProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultInfoboxProps:
        """Test ResultInfoboxProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultInfoboxProps`
        """
        model = ResultInfoboxProps()
        if include_optional:
            return ResultInfoboxProps(
                infobox = [
    ...
    def testResultInfoboxProps(self):
        """Test ResultInfoboxProps"""
