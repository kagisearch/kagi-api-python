...
class TestTranslateWordInsights200ResponseInsightsInner(unittest.TestCase):
    """TranslateWordInsights200ResponseInsightsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateWordInsights200ResponseInsightsInner:
        """Test TranslateWordInsights200ResponseInsightsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateWordInsights200ResponseInsightsInner`
        """
        model = TranslateWordInsights200ResponseInsightsInner()
        if include_optional:
            return TranslateWordInsights200ResponseInsightsInner(
                id = 'INSIGHT_1',
                original_text = 'Hola',
                variations = [
    ...
    def testTranslateWordInsights200ResponseInsightsInner(self):
        """Test TranslateWordInsights200ResponseInsightsInner"""
