...
class TestTranslateDictionary200ResponseLanguage(unittest.TestCase):
    """TranslateDictionary200ResponseLanguage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateDictionary200ResponseLanguage:
        """Test TranslateDictionary200ResponseLanguage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateDictionary200ResponseLanguage`
        """
        model = TranslateDictionary200ResponseLanguage()
        if include_optional:
            return TranslateDictionary200ResponseLanguage(
                iso = 'en',
                label = 'English'
            )
        else:
    ...
    def testTranslateDictionary200ResponseLanguage(self):
        """Test TranslateDictionary200ResponseLanguage"""
