...
class TestTranslateProofReadRequest(unittest.TestCase):
    """TranslateProofReadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateProofReadRequest:
        """Test TranslateProofReadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateProofReadRequest`
        """
        model = TranslateProofReadRequest()
        if include_optional:
            return TranslateProofReadRequest(
                text = '',
                source_lang = 'auto',
    ...
    def testTranslateProofReadRequest(self):
        """Test TranslateProofReadRequest"""
