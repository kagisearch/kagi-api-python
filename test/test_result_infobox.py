...
class TestResultInfobox(unittest.TestCase):
    """ResultInfobox unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultInfobox:
        """Test ResultInfobox
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultInfobox`
        """
        model = ResultInfobox()
        if include_optional:
            return ResultInfobox(
                url = '',
                title = '',
                snippet = '',
                time = '',
