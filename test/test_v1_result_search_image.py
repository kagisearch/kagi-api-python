...
class TestV1ResultSearchImage(unittest.TestCase):
    """V1ResultSearchImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResultSearchImage:
        """Test V1ResultSearchImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResultSearchImage`
        """
        model = V1ResultSearchImage()
        if include_optional:
            return V1ResultSearchImage(
                url = '',
                height = 56,
                width = 56
            )
    ...
    def testV1ResultSearchImage(self):
        """Test V1ResultSearchImage"""
