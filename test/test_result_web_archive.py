...
class TestResultWebArchive(unittest.TestCase):
    """ResultWebArchive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultWebArchive:
        """Test ResultWebArchive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultWebArchive`
        """
        model = ResultWebArchive()
        if include_optional:
            return ResultWebArchive(
                url = '',
                title = '',
                snippet = '',
                time = '',
