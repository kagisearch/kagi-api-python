...
class TestTranslateAlternatives200Response(unittest.TestCase):
    """TranslateAlternatives200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranslateAlternatives200Response:
        """Test TranslateAlternatives200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranslateAlternatives200Response`
        """
        model = TranslateAlternatives200Response()
        if include_optional:
            return TranslateAlternatives200Response(
                original_description = '',
                elements = [
                    openapi_client.models.translate_alternatives_200_response_elements_inner.translateAlternatives_200_response_elements_inner(
                        translation = '', 
                        explanation = '', )
                    ]
            )
    ...
    def testTranslateAlternatives200Response(self):
        """Test TranslateAlternatives200Response"""
