        ...
        if include_optional:
            return TranslateDictionary200Response(
                definition = openapi_client.models.translate_dictionary_200_response_definition.translateDictionary_200_response_definition(
                    ...
                    secondary_meanings = [{"definition":"An expression of surprise","part_of_speech":["exclamation"]},{"definition":"A call for attention","part_of_speech":["noun"]}], 
