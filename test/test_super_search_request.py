...
class TestSuperSearchRequest(unittest.TestCase):
    """SuperSearchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuperSearchRequest:
        """Test SuperSearchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuperSearchRequest`
        """
        model = SuperSearchRequest()
        if include_optional:
    ...
    def testSuperSearchRequest(self):
        """Test SuperSearchRequest"""
