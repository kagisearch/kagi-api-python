...
class TestResultSearchPropsThumbnailImage(unittest.TestCase):
    """ResultSearchPropsThumbnailImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultSearchPropsThumbnailImage:
        """Test ResultSearchPropsThumbnailImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultSearchPropsThumbnailImage`
        """
        model = ResultSearchPropsThumbnailImage()
        if include_optional:
            return ResultSearchPropsThumbnailImage(
                url = '',
                height = 56,
                width = 56
            )
    ...
    def testResultSearchPropsThumbnailImage(self):
        """Test ResultSearchPropsThumbnailImage"""
