...
class TestResultVideoProps(unittest.TestCase):
    """ResultVideoProps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultVideoProps:
        """Test ResultVideoProps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultVideoProps`
        """
        model = ResultVideoProps()
        if include_optional:
            return ResultVideoProps(
                hires_thumbnail_url = '',
                sort_normalize_url = '',
                sort_group_id = '',
                language = '',
