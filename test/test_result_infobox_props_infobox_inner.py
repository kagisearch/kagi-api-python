...
class TestResultInfoboxPropsInfoboxInner(unittest.TestCase):
    """ResultInfoboxPropsInfoboxInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultInfoboxPropsInfoboxInner:
        """Test ResultInfoboxPropsInfoboxInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultInfoboxPropsInfoboxInner`
        """
        model = ResultInfoboxPropsInfoboxInner()
        if include_optional:
            return ResultInfoboxPropsInfoboxInner(
                header = '',
                value = '',
                merged = True
            )
    ...
    def testResultInfoboxPropsInfoboxInner(self):
        """Test ResultInfoboxPropsInfoboxInner"""
