...
class SearchObject(BaseModel):
    ...
    image: Optional[SearchObjectImage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "thumbnail": SearchObjectThumbnail.from_dict(obj["thumbnail"]) if obj.get("thumbnail") is not None else None,
            "image": SearchObjectImage.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
