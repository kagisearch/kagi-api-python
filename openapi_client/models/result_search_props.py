...
class ResultSearchProps(BaseModel):
    """
    ResultSearchProps
    """ # noqa: E501
    thumbnail_image: Optional[ResultSearchPropsThumbnailImage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "thumbnail_image": ResultSearchPropsThumbnailImage.from_dict(obj["thumbnail_image"]) if obj.get("thumbnail_image") is not None else None,
