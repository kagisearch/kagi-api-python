...
class V1Meta(BaseModel):
    ...
    node: StrictStr
    ms: StrictInt
    query: Optional[V1MetaQuery] = None
    __properties: ClassVar[List[str]] = ["trace", "node", "ms", "query"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "node": obj.get("node"),
            "ms": obj.get("ms"),
            "query": V1MetaQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
