...
class TranslateListLanguagesPostRequest(BaseModel):
    """
    TranslateListLanguagesPostRequest
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of languages to return ('source' or 'target')")
    locale: Optional[StrictStr] = Field(default=None, description="Locale code to use for language names (e.g., 'en', 'de', 'fr')")
    __properties: ClassVar[List[str]] = ["type", "locale"]
