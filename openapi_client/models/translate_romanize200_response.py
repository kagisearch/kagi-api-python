...
class TranslateRomanize200Response(BaseModel):
    """
    TranslateRomanize200Response
    """ # noqa: E501
    romanization: Optional[StrictStr] = Field(default=None, description="Romanized text")
    __properties: ClassVar[List[str]] = ["romanization"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "romanization": obj.get("romanization")
        })
        return _obj
