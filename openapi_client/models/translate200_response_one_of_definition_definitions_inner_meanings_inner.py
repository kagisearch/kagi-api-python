...
class Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner(BaseModel):
    """
    Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner
    """ # noqa: E501
    definition: Optional[StrictStr] = Field(default=None, description="The definition text")
    example: Optional[StrictStr] = Field(default=None, description="Example usage")
    synonyms: Optional[List[StrictStr]] = Field(default=None, description="List of synonyms")
    __properties: ClassVar[List[str]] = ["definition", "example", "synonyms"]
