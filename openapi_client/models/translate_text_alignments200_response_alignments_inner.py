...
class TranslateTextAlignments200ResponseAlignmentsInner(BaseModel):
    """
    TranslateTextAlignments200ResponseAlignmentsInner
    """ # noqa: E501
    source: Optional[StrictStr] = Field(default=None, description="Source text segment")
    target: Optional[StrictStr] = Field(default=None, description="Corresponding target text segment")
