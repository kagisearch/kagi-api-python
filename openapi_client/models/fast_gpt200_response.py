...
class FastGPT200Response(BaseModel):
    """
    A response with a description and results references used
    """ # noqa: E501
    meta: Optional[Meta] = None
    data: Optional[FastGPT200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FastGPT200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
