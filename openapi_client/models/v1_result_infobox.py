...
class V1ResultInfobox(BaseModel):
    """
    V1ResultInfobox
    """ # noqa: E501
    url: StrictStr
    ...
    props: Optional[V1ResultInfoboxProps] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "props": V1ResultInfoboxProps.from_dict(obj["props"]) if obj.get("props") is not None else None
        })
        return _obj
