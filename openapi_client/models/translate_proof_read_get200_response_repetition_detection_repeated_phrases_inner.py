...
class TranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner(BaseModel):
    """
    TranslateProofReadGet200ResponseRepetitionDetectionRepeatedPhrasesInner
    """ # noqa: E501
    phrase: Optional[StrictStr] = Field(default=None, description="The repeated phrase")
    significance: Optional[StrictStr] = Field(default=None, description="The significance level of the repetition (high, medium, low)")
    __properties: ClassVar[List[str]] = ["phrase", "significance"]
