...
class SuperSearchRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["query", "workflow"]
    ...
    def workflow_validate_enum(cls, value):
        ...
        if value not in set(['search', 'images', 'videos', 'news', 'podcats']):
            raise ValueError("must be one of enum values ('search', 'images', 'videos', 'news', 'podcats')")
        return value
