...
class V1ResultWebArchive(BaseModel):
    """
    V1ResultWebArchive
    """ # noqa: E501
    url: StrictStr
    ...
    props: Optional[V1ResultWebArchiveProps] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "props": V1ResultWebArchiveProps.from_dict(obj["props"]) if obj.get("props") is not None else None
        })
        return _obj
