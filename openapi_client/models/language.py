...
class Language(BaseModel):
    ...
    Language
    """ # noqa: E501
    language: StrictStr = Field(description="Language code in ISO format (e.g., EN, FR, DE)")
    name: StrictStr = Field(description="Human-readable language name")
    supports_formality: StrictBool = Field(description="Whether formality is supported for this language")
