...
class TranslateListLanguages200ResponseInner(BaseModel):
    """
    TranslateListLanguages200ResponseInner
    """ # noqa: E501
    language: Optional[StrictStr] = Field(default=None, description="Language code")
    name: Optional[StrictStr] = Field(default=None, description="Language name")
    supports_formality: Optional[StrictBool] = Field(default=None, description="Whether formality is supported for this language")
    __properties: ClassVar[List[str]] = ["language", "name", "supports_formality"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "supports_formality": obj.get("supports_formality")
        })
        return _obj
