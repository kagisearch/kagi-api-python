...
class TranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner(BaseModel):
    """
    TranslateProofReadGet200ResponseRepetitionDetectionRepeatedWordsInner
    """ # noqa: E501
    word: Optional[StrictStr] = Field(default=None, description="The repeated word")
    significance: Optional[StrictStr] = Field(default=None, description="The significance level of the repetition (high, medium, low)")
    __properties: ClassVar[List[str]] = ["word", "significance"]
