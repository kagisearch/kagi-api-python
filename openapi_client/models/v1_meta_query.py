...
class V1MetaQuery(BaseModel):
    """
    V1MetaQuery
    """ # noqa: E501
    raw: Optional[StrictStr] = None
    terms: Optional[StrictStr] = None
    fields: Optional[List[V1MetaQueryFieldsInner]] = None
    workflow: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["raw", "terms", "fields", "workflow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "raw": obj.get("raw"),
            "terms": obj.get("terms"),
            "fields": [V1MetaQueryFieldsInner.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
