...
class TranslateDictionary200Response(BaseModel):
    """
    TranslateDictionary200Response
    """ # noqa: E501
    definition: Optional[TranslateDictionary200ResponseDefinition] = None
    language: Optional[TranslateDictionary200ResponseLanguage] = None
    __properties: ClassVar[List[str]] = ["definition", "language"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "definition": TranslateDictionary200ResponseDefinition.from_dict(obj["definition"]) if obj.get("definition") is not None else None,
            "language": TranslateDictionary200ResponseLanguage.from_dict(obj["language"]) if obj.get("language") is not None else None
        })
        return _obj
