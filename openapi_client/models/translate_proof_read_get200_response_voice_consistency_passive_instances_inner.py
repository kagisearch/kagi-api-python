...
class TranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner(BaseModel):
    """
    TranslateProofReadGet200ResponseVoiceConsistencyPassiveInstancesInner
    """ # noqa: E501
    passive: Optional[StrictStr] = Field(default=None, description="The passive voice construction")
    active_alternative: Optional[StrictStr] = Field(default=None, description="Suggested active voice alternative")
    __properties: ClassVar[List[str]] = ["passive", "active_alternative"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "active_alternative": obj.get("active_alternative")
        })
        return _obj
