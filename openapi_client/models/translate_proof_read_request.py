...
class TranslateProofReadRequest(BaseModel):
    """
    TranslateProofReadRequest
    """ # noqa: E501
    text: StrictStr = Field(description="Text content to proofread")
    ...
    explanation_language: Optional[StrictStr] = Field(default=None, description="Language code (ISO-639) for explanations and analysis. If not provided, explanations will be in the same language as the source text.")
    stream: Optional[StrictBool] = Field(default=False, description="Whether to stream the response as Server-Sent Events")
    __properties: ClassVar[List[str]] = ["text", "source_lang", "explanation_language", "stream"]
