...
class EnrichSearch200Response(BaseModel):
    """
    An array of search objects that can enrich a search query
    """ # noqa: E501
    meta: Optional[Meta] = None
    data: Optional[List[SearchObject]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [SearchObject.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
