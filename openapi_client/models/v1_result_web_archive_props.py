...
class V1ResultWebArchiveProps(BaseModel):
    """
    V1ResultWebArchiveProps
    """ # noqa: E501
    web_archive_domain: Optional[StrictStr] = None
    language: Optional[StrictStr] = None
    language_probability: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["web_archive_domain", "language", "language_probability"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "web_archive_domain": obj.get("web_archive_domain"),
