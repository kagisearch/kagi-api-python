...
class ResultInfoboxProps(BaseModel):
    """
    ResultInfoboxProps
    """ # noqa: E501
    infobox: Optional[List[ResultInfoboxPropsInfoboxInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "infobox": [ResultInfoboxPropsInfoboxInner.from_dict(_item) for _item in obj["infobox"]] if obj.get("infobox") is not None else None,
