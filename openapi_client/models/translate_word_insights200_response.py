...
class TranslateWordInsights200Response(BaseModel):
    """
    TranslateWordInsights200Response
    """ # noqa: E501
    marked_translation: Optional[StrictStr] = Field(default=None, description="The translated text with markers (<<INSIGHT_N>>) indicating insight locations")
    insights: Optional[List[TranslateWordInsights200ResponseInsightsInner]] = None
    __properties: ClassVar[List[str]] = ["marked_translation", "insights"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "marked_translation": obj.get("marked_translation"),
            "insights": [TranslateWordInsights200ResponseInsightsInner.from_dict(_item) for _item in obj["insights"]] if obj.get("insights") is not None else None
        })
        return _obj
