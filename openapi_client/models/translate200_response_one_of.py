...
class Translate200ResponseOneOf(BaseModel):
    """
    Translate200ResponseOneOf
    """ # noqa: E501
    translation: Optional[StrictStr] = Field(default=None, description="Translated text")
    detected_language: Optional[Translate200ResponseOneOfDetectedLanguage] = Field(default=None, alias="detectedLanguage")
    definition: Optional[Translate200ResponseOneOfDefinition] = None
    __properties: ClassVar[List[str]] = ["translation", "detectedLanguage", "definition"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "detectedLanguage": Translate200ResponseOneOfDetectedLanguage.from_dict(obj["detectedLanguage"]) if obj.get("detectedLanguage") is not None else None,
            "definition": Translate200ResponseOneOfDefinition.from_dict(obj["definition"]) if obj.get("definition") is not None else None
        })
        return _obj
