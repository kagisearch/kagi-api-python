...
class TranslateDictionary200ResponseDefinitionPrimaryMeaning(BaseModel):
    """
    The primary or most common meaning
    """ # noqa: E501
    definition: Optional[StrictStr] = Field(default=None, description="The text of the primary definition (translated to definition_language)")
    part_of_speech: Optional[List[StrictStr]] = Field(default=None, description="The part(s) of speech that apply to this specific meaning (translated to definition_language)")
    usage_level: Optional[List[StrictStr]] = Field(default=None, description="Register or context where this specific meaning is used (formal, informal, slang, technical, etc.) - translated to definition_language")
    dialect: Optional[List[StrictStr]] = Field(default=None, description="Specific dialects where this meaning is used (e.g., \"US\", \"UK\", \"Australian\")")
    synonyms: Optional[List[StrictStr]] = Field(default=None, description="List of synonyms for this meaning, ordered from strongest/closest to least similar (remains in word_language)")
    __properties: ClassVar[List[str]] = ["definition", "part_of_speech", "usage_level", "dialect", "synonyms"]
