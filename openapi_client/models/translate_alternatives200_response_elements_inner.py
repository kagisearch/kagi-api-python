...
class TranslateAlternatives200ResponseElementsInner(BaseModel):
    """
    TranslateAlternatives200ResponseElementsInner
    """ # noqa: E501
    translation: Optional[StrictStr] = Field(default=None, description="Alternative translation or phrasing")
    explanation: Optional[StrictStr] = Field(default=None, description="Explanation of the alternative in the requested language")
    __properties: ClassVar[List[str]] = ["translation", "explanation"]
