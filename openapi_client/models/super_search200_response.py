...
class SuperSearch200Response(BaseModel):
    """
    A response with a description and results references used
    """ # noqa: E501
    meta: Optional[V1Meta] = None
    data: Optional[SuperSearch200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SuperSearch200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
