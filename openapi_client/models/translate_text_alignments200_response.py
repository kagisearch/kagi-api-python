...
class TranslateTextAlignments200Response(BaseModel):
    """
    TranslateTextAlignments200Response
    """ # noqa: E501
    alignments: Optional[List[TranslateTextAlignments200ResponseAlignmentsInner]] = Field(default=None, description="Array of alignment entries between source and target text segments")
    __properties: ClassVar[List[str]] = ["alignments"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.alignments:
            for _item_alignments in self.alignments:
                if _item_alignments:
                    _items.append(_item_alignments.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alignments": [TranslateTextAlignments200ResponseAlignmentsInner.from_dict(_item) for _item in obj["alignments"]] if obj.get("alignments") is not None else None
        })
        return _obj
