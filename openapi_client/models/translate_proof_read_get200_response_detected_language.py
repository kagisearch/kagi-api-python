...
class TranslateProofReadGet200ResponseDetectedLanguage(BaseModel):
    """
    TranslateProofReadGet200ResponseDetectedLanguage
    """ # noqa: E501
    iso: Optional[StrictStr] = Field(default=None, description="ISO code of detected source language")
    label: Optional[StrictStr] = Field(default=None, description="Human-readable language name")
    __properties: ClassVar[List[str]] = ["iso", "label"]
