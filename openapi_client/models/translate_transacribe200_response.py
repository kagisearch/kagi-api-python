...
class TranslateTransacribe200Response(BaseModel):
    """
    TranslateTransacribe200Response
    """ # noqa: E501
    transcription: Optional[StrictStr] = Field(default=None, description="The transcribed text, with appropriate punctuation and formatting")
    detected_language: Optional[StrictStr] = Field(default=None, description="The detected language code (when using automatic detection)")
    __properties: ClassVar[List[str]] = ["transcription", "detected_language"]
