...
class Translate200ResponseOneOf1(BaseModel):
    """
    Translate200ResponseOneOf1
    """ # noqa: E501
    snippets: Optional[List[StrictStr]] = Field(default=None, description="Array of translated text snippets (for batch translation). The order matches the input array and preserves context between snippets.")
