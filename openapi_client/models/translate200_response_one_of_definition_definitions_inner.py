...
class Translate200ResponseOneOfDefinitionDefinitionsInner(BaseModel):
    """
    Translate200ResponseOneOfDefinitionDefinitionsInner
    """ # noqa: E501
    part_of_speech: Optional[StrictStr] = Field(default=None, description="Part of speech", alias="partOfSpeech")
    meanings: Optional[List[Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner]] = None
    __properties: ClassVar[List[str]] = ["partOfSpeech", "meanings"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in meanings (list)
        _items = []
        if self.meanings:
            for _item_meanings in self.meanings:
                if _item_meanings:
                    _items.append(_item_meanings.to_dict())
            _dict['meanings'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meanings": [Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner.from_dict(_item) for _item in obj["meanings"]] if obj.get("meanings") is not None else None
        })
        return _obj
