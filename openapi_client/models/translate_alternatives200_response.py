...
class TranslateAlternatives200Response(BaseModel):
    """
    TranslateAlternatives200Response
    """ # noqa: E501
    original_description: Optional[StrictStr] = Field(default=None, description="A short description of the style, formality, or key characteristics of the text", alias="originalDescription")
    elements: Optional[List[TranslateAlternatives200ResponseElementsInner]] = None
    __properties: ClassVar[List[str]] = ["originalDescription", "elements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "elements": [TranslateAlternatives200ResponseElementsInner.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
        })
        return _obj
