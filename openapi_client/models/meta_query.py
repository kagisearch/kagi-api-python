...
class MetaQuery(BaseModel):
    ...
    fields: Optional[List[MetaQueryFieldsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "raw": obj.get("raw"),
            "terms": obj.get("terms"),
            "fields": [MetaQueryFieldsInner.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
