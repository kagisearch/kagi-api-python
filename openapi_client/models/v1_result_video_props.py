...
class V1ResultVideoProps(BaseModel):
    """
    V1ResultVideoProps
    """ # noqa: E501
    hires_thumbnail_url: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["hires_thumbnail_url", "sort_normalize_url", "sort_group_id", "language", "language_probability", "source_history"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hires_thumbnail_url": obj.get("hires_thumbnail_url"),
