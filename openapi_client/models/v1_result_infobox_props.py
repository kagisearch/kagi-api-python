...
class V1ResultInfoboxProps(BaseModel):
    """
    V1ResultInfoboxProps
    """ # noqa: E501
    infobox: Optional[List[V1ResultInfoboxPropsInfoboxInner]] = None
    wikipedia_subtext: Optional[StrictStr] = Field(default=None, alias="wikipedia.subtext")
    wikipedia_page_id: Optional[StrictInt] = Field(default=None, alias="wikipedia.page_id")
    ...
    __properties: ClassVar[List[str]] = ["infobox", "wikipedia.subtext", "wikipedia.page_id", "language", "language_probability", "sort_normalize_url", "sort_group_id", "source_history"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "infobox": [V1ResultInfoboxPropsInfoboxInner.from_dict(_item) for _item in obj["infobox"]] if obj.get("infobox") is not None else None,
            "wikipedia.subtext": obj.get("wikipedia.subtext"),
            "wikipedia.page_id": obj.get("wikipedia.page_id"),
