...
class ResultInfobox(BaseModel):
    ...
    props: Optional[ResultInfoboxProps] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "props": ResultInfoboxProps.from_dict(obj["props"]) if obj.get("props") is not None else None
        })
        return _obj
