...
class TranslateProofReadGet200ResponseToneAnalysis(BaseModel):
    """
    Analysis of the text's tone
    """ # noqa: E501
    overall_tone: Optional[StrictStr] = Field(default=None, description="The primary tone of the text (formal, informal, neutral, friendly, academic, professional, casual, etc.)")
    description: Optional[StrictStr] = Field(default=None, description="Brief description of the tone of the text")
    suggestions: Optional[StrictStr] = Field(default=None, description="Optional suggestions for tone adjustment if needed")
    __properties: ClassVar[List[str]] = ["overall_tone", "description", "suggestions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overall_tone": obj.get("overall_tone"),
