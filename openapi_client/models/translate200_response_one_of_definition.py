...
class Translate200ResponseOneOfDefinition(BaseModel):
    """
    ...
    phonetic: Optional[StrictStr] = Field(default=None, description="Phonetic pronunciation")
    definitions: Optional[List[Translate200ResponseOneOfDefinitionDefinitionsInner]] = None
    __properties: ClassVar[List[str]] = ["word", "phonetic", "definitions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "definitions": [Translate200ResponseOneOfDefinitionDefinitionsInner.from_dict(_item) for _item in obj["definitions"]] if obj.get("definitions") is not None else None
        })
        return _obj
