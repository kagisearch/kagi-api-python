...
class TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner(BaseModel):
    """
    TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner
    """ # noqa: E501
    definition: Optional[StrictStr] = Field(default=None, description="The text of a secondary definition")
    part_of_speech: Optional[List[StrictStr]] = Field(default=None, description="The part(s) of speech that apply to this specific meaning")
    usage_level: Optional[List[StrictStr]] = Field(default=None, description="Register or context where this specific meaning is used (formal, informal, slang, technical, etc.)")
    dialect: Optional[List[StrictStr]] = Field(default=None, description="Specific dialects where this meaning is used")
    synonyms: Optional[List[StrictStr]] = Field(default=None, description="List of synonyms for this meaning, ordered from strongest/closest to least similar")
